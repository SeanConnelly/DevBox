...
define("vs/editor/editor.main.nls.it", {
	...
	"vs/editor/common/config/editorOptions": [
		...
		"Abilita i suggerimenti incorporati nell\'EditManager.",
		...
		"Controlla la famiglia di caratteri dei suggerimenti incorporati nell\'EditManager. Se impostato su vuoto, viene usato \'#editor.fontFamily#\'.",
		...
		"Controlla se visualizzare automaticamente i suggerimenti inline nell\'EditManager.",
		...
		"Controlla se visualizzare in anteprima il risultato del suggerimento nell\'EditManager.",
		...
		"Controlla il numero di righe nell\'EditManager che possono essere lette alla volta da un utilità per la lettura dello schermo. Quando viene rilevata un\'utilità per la lettura dello schermo, questo valore viene impostato su 500 per impostazione predefinita. Avviso: questa opzione può influire sulle prestazioni se il numero di righe è superiore a quello predefinito.",
		"Contenuto editor",
	...
	"vs/editor/common/core/editorColorRegistry": [
		...
		"Colore del bordo del testo fantasma nell\'EditManager.",
		"Colore primo piano del testo fantasma nell\'EditManager.",
