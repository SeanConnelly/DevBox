...
define("vs/editor/editor.main.nls.de", {
	...
	"vs/editor/browser/controller/textAreaHandler": [
		"Editor",
		"Auf den EditManager kann derzeit nicht zugegriffen werden. Drücken Sie {0}, um die Optionen anzuzeigen.",
	],
	...
	"vs/editor/browser/widget/diffEditorWidget": [
		"Zeilenformatierung für Einfügungen im Diff-EditManager",
		"Zeilenformatierung für Entfernungen im Diff-EditManager",
	...
	"vs/editor/common/config/editorConfigurationSchema": [
		...
		"Steuert, ob der Diff-EditManager die Unterschiede nebeneinander oder im Text anzeigt.",
		"Wenn aktiviert, ignoriert der Diff-EditManager Änderungen an voran- oder nachgestellten Leerzeichen.",
		"Steuert, ob der Diff-EditManager die Indikatoren \"+\" und \"-\" für hinzugefügte/entfernte Änderungen anzeigt.",
		"Steuert, ob der EditManager CodeLens anzeigt.",
	...
	"vs/editor/common/config/editorOptions": [
		"Der EditManager verwendet Plattform-APIs, um zu erkennen, wenn eine Sprachausgabe angefügt wird.",
		"Der EditManager wird dauerhaft für die Verwendung mit einer Sprachausgabe optimiert. Zeilenumbrüche werden deaktiviert.",
		"Der EditManager wird nie für die Verwendung mit einer Sprachausgabe optimiert.",
		"Steuert, ob der EditManager in einem für die Sprachausgabe optimierten Modus ausgeführt werden soll. Durch Festlegen auf \"Ein\" werden Zeilenumbrüche deaktiviert.",
		...
		"Aktiviert das Glühbirnensymbol für Codeaktionen im EditManager.",
		"Aktiviert die Inlay-Hinweise im EditManager.",
		"Steuert den Schriftgrad von Inlayhinweisen im EditManager. Ein Standardwert von 90 % der \"#editor.fontSize#\" wird verwendet, wenn der konfigurierte Wert kleiner als „5“ oder größer als der Schriftgrad des Editors ist.",
		"Steuert die Schriftfamilie für Inlay-Hinweise im EditManager. Wenn der Wert „leer“ festgelegt wird, wird die „#editor.fontFamily#“ verwendet.",
		...
		"Die Minimap hat die gleiche Größe wie der EditManager-Inhalt (und kann scrollen).",
		"Die Minimap wird bei Bedarf vergrößert oder verkleinert, um die Höhe des Editors zu füllen (kein Scrollen).",
		"Die Minimap wird bei Bedarf verkleinert, damit sie nicht größer als der EditManager ist (kein Scrollen).",
		...
		"Anzahl der Zeichen aus Festbreitenschriftarten, ab der dieses EditManager-Lineal gerendert wird.",
		"Farbe dieses EditManager-Lineals.",
		...
		"Steuert, ob Inline-Vorschläge automatisch im EditManager angezeigt werden.",
		...
		"Steuert, ob der EditManager das aktive Klammerpaar hervorheben soll.",
		"Steuert, ob der EditManager Einzugsführungslinien rendern soll.",
		"Steuert, ob der EditManager die aktive Einzugsführungslinie hevorheben soll.",
		...
		"Steuert, ob das Ergebnis des Vorschlags im EditManager in der Vorschau angezeigt werden soll.",
		...
		"Steuert die Anzahl von Zeilen im EditManager, die von einer Sprachausgabe in einem Arbeitsschritt gelesen werden können. Wenn eine Sprachausgabe erkannt wird, wird der Standardwert automatisch auf 500 festgelegt. Warnung: Ein Wert höher als der Standardwert, kann sich auf die Leistung auswirken.",
		"EditManager-Inhalt",
		...
		"Steuert, ob der EditManager automatisch Klammern schließen soll, nachdem der Benutzer eine öffnende Klammer hinzugefügt hat.",
		"Angrenzende schließende Anführungszeichen oder Klammern werden nur überschrieben, wenn sie automatisch eingefügt wurden.",
		"Steuert, ob der EditManager angrenzende schließende Anführungszeichen oder Klammern beim Löschen entfernen soll.",
		"Schließende Anführungszeichen oder Klammern werden nur überschrieben, wenn sie automatisch eingefügt wurden.",
		"Steuert, ob der EditManager schließende Anführungszeichen oder Klammern überschreiben soll.",
		...
		"Steuert, ob der EditManager Anführungszeichen automatisch schließen soll, nachdem der Benutzer ein öffnendes Anführungszeichen hinzugefügt hat.",
		"Der EditManager fügt den Einzug nicht automatisch ein.",
		"Der EditManager behält den Einzug der aktuellen Zeile bei.",
		"Der EditManager behält den in der aktuellen Zeile definierten Einzug bei und beachtet für Sprachen definierte Klammern.",
		"Der EditManager behält den Einzug der aktuellen Zeile bei, beachtet von Sprachen definierte Klammern und ruft spezielle onEnterRules-Regeln auf, die von Sprachen definiert wurden.",
		"Der EditManager behält den Einzug der aktuellen Zeile bei, beachtet die von Sprachen definierten Klammern, ruft von Sprachen definierte spezielle onEnterRules-Regeln auf und beachtet von Sprachen definierte indentationRules-Regeln.",
		"Legt fest, ob der EditManager den Einzug automatisch anpassen soll, wenn Benutzer Zeilen eingeben, einfügen, verschieben oder einrücken",
		...
		"Steuert, ob der EditManager die Auswahl beim Eingeben von Anführungszeichen oder Klammern automatisch umschließt.",
		...
		"Steuert, ob der EditManager die Inline-Farbdecorators und die Farbauswahl rendern soll.",
		...
		"Steuert, ob der EditManager das Verschieben einer Auswahl per Drag and Drop zulässt.",
		"Multiplikator für Scrollgeschwindigkeit bei Drücken von ALT.",
		"Steuert, ob Codefaltung im EditManager aktiviert ist.",
		...
		"Steuert, ob der EditManager eingefaltete Bereiche hervorheben soll.",
		"Steuert, ob der EditManager Importbereiche automatisch reduziert.",
		"Die maximale Anzahl von faltbaren Regionen. Eine Erhöhung dieses Werts kann dazu führen, dass der EditManager weniger reaktionsfähig wird, wenn die aktuelle Quelle eine große Anzahl von faltbaren Regionen aufweist.",
		...
		"Steuert, ob der EditManager den eingefügten Inhalt automatisch formatieren soll. Es muss ein Formatierer vorhanden sein, der in der Lage ist, auch Dokumentbereiche zu formatieren.",
		"Steuert, ob der EditManager die Zeile nach der Eingabe automatisch formatieren soll.",
		"Steuert, ob der EditManager den vertikalen Glyphenrand rendert. Der Glyphenrand wird hauptsächlich zum Debuggen verwendet.",
		"Steuert, ob der Cursor im Übersichtslineal ausgeblendet werden soll.",
		"Legt den Abstand der Buchstaben in Pixeln fest.",
		"Steuert, ob die verknüpfte Bearbeitung im EditManager aktiviert ist. Abhängig von der Sprache werden zugehörige Symbole, z. B. HTML-Tags, während der Bearbeitung aktualisiert.",
		"Steuert, ob der EditManager Links erkennen und anklickbar machen soll.",
		...
		"Steuert, ob der EditManager das Vorkommen semantischer Symbole hervorheben soll.",
		"Steuert, ob um das Übersichtslineal ein Rahmen gezeichnet werden soll.",
		"Struktur beim Öffnen des Peek-Editors fokussieren",
		"EditManager fokussieren, wenn Sie den Peek-EditManager öffnen",
		"Steuert, ob der Inline-EditManager oder die Struktur im Peek-Widget fokussiert werden soll.",
		...
		"Steuert, ob der EditManager bei Eingabe automatisch eine Umbenennung vornimmt.",
		"Veraltet. Verwenden Sie stattdessen \"editor.linkedEditing\".",
		"Steuert, ob der EditManager Steuerzeichen rendern soll.",
		"Letzte Zeilennummer rendern, wenn die Datei mit einem Zeilenumbruch endet.",
		"Hebt den Bundsteg und die aktuelle Zeile hervor.",
		"Steuert, wie der EditManager die aktuelle Zeilenhervorhebung rendern soll.",
		"Steuert, ob der EditManager die aktuelle Zeilenhervorhebung nur dann rendern soll, wenn der Fokus auf dem EditManager liegt.",
		...
		"Steuert, wie der EditManager Leerzeichen rendern soll.",
		"Steuert, ob eine Auswahl abgerundete Ecken aufweisen soll.",
		"Steuert die Anzahl der zusätzlichen Zeichen, nach denen der EditManager horizontal scrollt.",
		"Steuert, ob der EditManager jenseits der letzten Zeile scrollen wird.",
		...
		"Steuert, ob der EditManager Übereinstimmungen hervorheben soll, die der Auswahl ähneln.",
		...
		"Legt fest, ob der EditManager Bildläufe animiert ausführt.",
	...
	"vs/editor/common/core/editorColorRegistry": [
		...
		"Farbe des Cursors im EditManager.",
		"Hintergrundfarbe vom EditManager-Cursor. Erlaubt die Anpassung der Farbe von einem Zeichen, welches von einem Block-Cursor überdeckt wird.",
		"Farbe der Leerzeichen im EditManager.",
		"Farbe der Führungslinien für Einzüge im EditManager.",
		"Farbe der Führungslinien für Einzüge im aktiven EditManager.",
		"Zeilennummernfarbe im EditManager.",
		...
		"Zeilennummernfarbe der aktiven Editorzeile.",
		"Farbe des EditManager-Lineals.",
		"Vordergrundfarbe der CodeLens-Links im EditManager",
		...
		"Hintergrundfarbe des Übersichtslineals im EditManager. Wird nur verwendet, wenn die Minimap aktiviert ist und auf der rechten Seite des Editors platziert wird.",
		"Hintergrundfarbe der Editorleiste. Die Leiste enthält die Glyphenränder und die Zeilennummern.",
		"Rahmenfarbe unnötigen (nicht genutzten) Quellcodes im EditManager.",
		"Deckkraft des unnötigen (nicht genutzten) Quellcodes im EditManager. \"#000000c0\" rendert z.B. den Code mit einer Deckkraft von 75%. Verwenden Sie für Designs mit hohem Kontrast das Farbdesign \"editorUnnecessaryCode.border\", um unnötigen Code zu unterstreichen statt ihn abzublenden.",
		"Rahmenfarbe des Ghost-Texts im EditManager.",
		"Vordergrundfarbe des Ghost-Texts im EditManager.",
		"Hintergrundfarbe des Ghost-Texts im EditManager.",
	...
	"vs/editor/common/editorContextKeys": [
		"Gibt an, ob der EditManager-Text den Fokus besitzt (Cursor blinkt).",
		"Gibt an, ob der EditManager oder ein EditManager-Widget den Fokus besitzt (z. B. ob der Fokus sich im Suchwidget befindet).",
		"Gibt an, ob ein EditManager oder eine Rich-Text-Eingabe den Fokus besitzt (Cursor blinkt).",
		"Gibt an, ob der EditManager schreibgeschützt ist.",
		"Gibt an, ob der Kontext ein Diff-EditManager ist.",
		"Gibt an, ob \"editor.columnSelection\" aktiviert ist.",
		"Gibt an, ob im EditManager Text ausgewählt ist.",
		"Gibt an, ob der EditManager über Mehrfachauswahl verfügt.",
		"Gibt an, ob die TAB-TASTE den Fokus aus dem EditManager verschiebt.",
		"Gibt an, ob Hover im EditManager sichtbar ist.",
		"Gibt an, ob der EditManager Bestandteil eines größeren Editors ist (z. B. Notebooks).",
		"Der Sprachbezeichner des Editors.",
		"Gibt an, ob der EditManager über einen Vervollständigungselementanbieter verfügt.",
		"Gibt an, ob der EditManager über einen Codeaktionsanbieter verfügt.",
		"Gibt an, ob der EditManager über einen CodeLens-Anbieter verfügt.",
		"Gibt an, ob der EditManager über einen Definitionsanbieter verfügt.",
		"Gibt an, ob der EditManager über einen Deklarationsanbieter verfügt.",
		"Gibt an, ob der EditManager über einen Implementierungsanbieter verfügt.",
		"Gibt an, ob der EditManager über einen Typdefinitionsanbieter verfügt.",
		"Gibt an, ob der EditManager über einen Hoveranbieter verfügt.",
		"Gibt an, ob der EditManager über einen Dokumenthervorhebungsanbieter verfügt.",
		"Gibt an, ob der EditManager über einen Dokumentsymbolanbieter verfügt.",
		"Gibt an, ob der EditManager über einen Verweisanbieter verfügt.",
		"Gibt an, ob der EditManager über einen Umbenennungsanbieter verfügt.",
		"Gibt an, ob der EditManager über einen Signaturhilfeanbieter verfügt.",
		"Gibt an, ob der EditManager über einen Inlinehinweisanbieter verfügt.",
		"Gibt an, ob der EditManager über einen Dokumentformatierungsanbieter verfügt.",
		"Gibt an, ob der EditManager über einen Anbieter für Dokumentauswahlformatierung verfügt.",
		"Gibt an, ob der EditManager über mehrere Dokumentformatierungsanbieter verfügt.",
		"Gibt an, ob der EditManager über mehrere Anbieter für Dokumentauswahlformatierung verfügt.",
	],
	...
	"vs/editor/common/standaloneStrings": [
		...
		" in einem schreibgeschützten Code-EditManager",
		" in einem Code-EditManager",
		"Drücken Sie BEFEHLSTASTE + E, um den EditManager für eine optimierte Verwendung mit Sprachausgabe zu konfigurieren.",
		"Drücken Sie STRG + E, um den EditManager für eine optimierte Verwendung mit Sprachausgabe zu konfigurieren.",
		"Der EditManager ist auf eine optimale Verwendung mit Sprachausgabe konfiguriert.",
		"Der EditManager ist so konfiguriert, dass er nie auf die Verwendung mit Sprachausgabe hin optimiert wird. Dies ist zu diesem Zeitpunkt nicht der Fall.",
		"Durch Drücken der TAB-TASTE im aktuellen EditManager wird der Fokus in das nächste Element verschoben, das den Fokus erhalten kann. Schalten Sie dieses Verhalten um, indem Sie {0} drücken.",
		"Durch Drücken der TAB-TASTE im aktuellen EditManager wird der Fokus in das nächste Element verschoben, das den Fokus erhalten kann. Der {0}-Befehl kann zurzeit nicht durch eine Tastenzuordnung ausgelöst werden.",
		"Durch Drücken der TAB-TASTE im aktuellen EditManager wird das Tabstoppzeichen eingefügt. Schalten Sie dieses Verhalten um, indem Sie {0} drücken.",
		"Durch Drücken der TAB-TASTE im aktuellen EditManager wird das Tabstoppzeichen eingefügt. Der {0}-Befehl kann zurzeit nicht durch eine Tastenzuordnung ausgelöst werden.",
		...
		"Sie können diese QuickInfo schließen und durch Drücken von ESC oder UMSCHALT+ESC zum EditManager zurückkehren.",
	...
	"vs/editor/contrib/contextmenu/browser/contextmenu": [
		"EditManager-Kontextmenü anzeigen",
	],
	...
	"vs/editor/contrib/editorState/browser/keybindingCancellation": [
		"Gibt an, ob der EditManager einen abbrechbaren Vorgang ausführt, z. B. \"Verweisvorschau\".",
	],
	...
	"vs/editor/contrib/find/browser/findWidget": [
		"Symbol für \"In Auswahl suchen\" im EditManager-Such-Widget.",
		"Symbol für die Anzeige, dass das EditManager-Such-Widget zugeklappt wurde.",
		"Symbol für die Anzeige, dass das EditManager-Such-Widget aufgeklappt wurde.",
		"Symbol für \"Ersetzen\" im EditManager-Such-Widget.",
		"Symbol für \"Alle ersetzen\" im EditManager-Such-Widget.",
		"Symbol für \"Vorheriges Element suchen\" im EditManager-Such-Widget.",
		"Symbol für \"Nächstes Element suchen\" im EditManager-Such-Widget.",
		"Suchen",
		"Suchen",
	...
	"vs/editor/contrib/folding/browser/folding": [
		...
		"Farbe des Faltsteuerelements im EditManager-Bundsteg.",
	],
	"vs/editor/contrib/folding/browser/foldingDecorations": [
		"Symbol für aufgeklappte Bereiche im EditManager-Glyphenrand.",
		"Symbol für zugeklappte Bereiche im EditManager-Glyphenrand.",
	],
	"vs/editor/contrib/fontZoom/browser/fontZoom": [
		"Editorschriftart vergrößern",
		"Editorschriftart verkleinern",
		"EditManager Schriftart Vergrößerung zurücksetzen",
	],
	...
	"vs/editor/contrib/gotoError/browser/gotoErrorWidget": [
		...
		"Hintergrund der Fehlerüberschrift des Markernavigationswidgets im EditManager.",
		"Editormarkierung: Farbe bei Warnung des Navigationswidgets.",
		"Hintergrund der Warnungsüberschrift des Markernavigationswidgets im EditManager.",
		"Editormarkierung: Farbe bei Information des Navigationswidgets.",
		"Hintergrund der Informationsüberschrift des Markernavigationswidgets im EditManager.",
	...
	"vs/editor/contrib/linkedEditing/browser/linkedEditing": [
		...
		"Hintergrundfarbe, wenn der EditManager automatisch nach Typ umbenennt.",
	],
	...
	"vs/editor/contrib/message/browser/messageController": [
		"Gibt an, ob der EditManager zurzeit eine Inlinenachricht anzeigt.",
		"Ein Bearbeiten ist im schreibgeschützten EditManager nicht möglich",
	],
	...
	"vs/editor/contrib/peekView/browser/peekView": [
		"Gibt an, ob der aktuelle Code-EditManager in der Vorschau eingebettet ist.",
		"Schließen",
		...
		"Hintergrundfarbe der Leiste im Peek-EditManager.",
		"Farbe für Übereinstimmungsmarkierungen in der Ergebnisliste der Peek-Ansicht.",
		"Farbe für Übereinstimmungsmarkierungen im Peek-EditManager.",
		"Rahmen für Übereinstimmungsmarkierungen im Peek-EditManager.",
	],
	"vs/editor/contrib/quickAccess/browser/gotoLineQuickAccess": [
		"Öffnen Sie zuerst einen Text-EditManager, um zu einer Zeile zu wechseln.",
	...
	"vs/editor/contrib/quickAccess/browser/gotoSymbolQuickAccess": [
		"Öffnen Sie zunächst einen Text-EditManager mit Symbolinformationen, um zu einem Symbol zu navigieren.",
		"Der aktive Text-EditManager stellt keine Symbolinformationen bereit.",
	...
	"vs/editor/contrib/snippet/browser/snippetController2": [
		"Gibt an, ob der EditManager sich zurzeit im Schnipselmodus befindet.",
	...
	"vs/editor/contrib/unicodeHighlighter/browser/unicodeHighlighter": [
		"Symbol, das mit einer Warnmeldung im Erweiterungs-EditManager angezeigt wird.",
	...
	"vs/platform/configuration/common/configurationRegistry": [
		...
		"Zu überschreibende EditManager-Einstellungen für eine Sprache konfigurieren.",
		"Diese Einstellung unterstützt keine sprachspezifische Konfiguration.",
		"Zu überschreibende EditManager-Einstellungen für eine Sprache konfigurieren.",
		"Diese Einstellung unterstützt keine sprachspezifische Konfiguration.",
		"Eine leere Eigenschaft kann nicht registriert werden.",
		"\"{0}\" kann nicht registriert werden. Stimmt mit dem Eigenschaftsmuster \"\\\\[.*\\\\]$\" zum Beschreiben sprachspezifischer EditManager-Einstellungen überein. Verwenden Sie den Beitrag \"configurationDefaults\".",
	...
	"vs/platform/theme/common/colorRegistry": [
		...
		"Hintergrundfarbe der Textauswahl in der Workbench (z.B. für Eingabefelder oder Textbereiche). Diese Farbe gilt nicht für die Auswahl im EditManager.",
		...
		"Hintergrundfarbe für Fehlertext im EditManager. Die Farbe darf nicht deckend sein, weil sie sonst die zugrunde liegenden Dekorationen verdeckt.",
		"Vordergrundfarbe von Fehlerunterstreichungen im EditManager.",
		"Randfarbe von Fehlerfeldern im EditManager.",
		"Hintergrundfarbe für Warnungstext im EditManager. Die Farbe darf nicht deckend sein, weil sie sonst die zugrunde liegenden Dekorationen verdeckt.",
		"Vordergrundfarbe von Warnungsunterstreichungen im EditManager.",
		"Randfarbe der Warnfelder im EditManager.",
		"Hintergrundfarbe für Infotext im EditManager. Die Farbe darf nicht deckend sein, weil sie sonst die zugrunde liegenden Dekorationen verdeckt.",
		"Vordergrundfarbe von Informationsunterstreichungen im EditManager.",
		"Randfarbe der Infofelder im EditManager.",
		"Vordergrundfarbe der Hinweisunterstreichungen im EditManager.",
		"Randfarbe der Hinweisfelder im EditManager.",
		"Rahmenfarbe aktiver Trennleisten.",
		"Hintergrundfarbe des Editors.",
		"Standardvordergrundfarbe des Editors.",
		"Hintergrundfarbe von EditManager-Widgets wie zum Beispiel Suchen/Ersetzen.",
		...
		"Farbe der EditManager-Auswahl.",
		"Farbe des gewählten Text für einen hohen Kontrast",
		"Die Farbe der Auswahl befindet sich in einem inaktiven EditManager. Die Farbe darf nicht deckend sein, weil sie sonst die zugrunde liegende Dekorationen verdeckt.",
		...
		"Hintergrundfarbe des EditManager-Mauszeigers.",
		"Vordergrundfarbe des EditManager-Mauszeigers",
		"Rahmenfarbe des EditManager-Mauszeigers.",
		...
		"Vordergrundfarbe einer Liste/Struktur für ungültige Elemente, z.B. ein nicht ausgelöster Stamm im DocumentExplorer.",
	...
	"vs/platform/theme/common/iconRegistry": [
		...
		"Symbol für den Wechsel zur vorherigen EditManager-Position.",
		"Symbol für den Wechsel zur nächsten EditManager-Position.",
	],
